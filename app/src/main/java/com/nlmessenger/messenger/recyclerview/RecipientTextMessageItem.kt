...
class RecipientTextMessageItem(val textMessage: TextMessage, val messageId: String, val context: Context) : Item (){
    ...
    override fun getLayout(): Int {
        return R.layout.rv_item_text_message_recipient
    }
